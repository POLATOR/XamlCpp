...
struct xaml_button_internal : xaml_control_internal
{
    ...
    XAML_EVENT_IMPL(pressed_changed, xaml_object, bool)
    XAML_PROP_EVENT_IMPL(pressed, bool, bool *, bool)
    ...
    void on_pressed() noexcept;
    void on_released() noexcept;
...
struct xaml_button_implement : xaml_control_implement<T, Internal, Base>
{
    ...
    XAML_EVENT_INTERNAL_IMPL(pressed_changed, xaml_object, bool)
    XAML_PROP_INTERNAL_IMPL(pressed, bool *, bool)
